...
export default function ManageBlogsPage() {
  ...
  const fetchBlogs = useCallback(async () => {
    try {
      setLoading(true);
      const response = await fetch(`${API_URL}/api/blogs/admin/all?page=${currentPage}&limit=${pageSize}`, {
        credentials: 'include',
    ...
    },
    {
      ...
      render: (_, record) => (
        <Space size="small">
          ...
          <Tooltip title="Edit">
            <Link href={`/moderator/blog/edit/${record._id}`}>
              <EditOutlined />
            </Link>
          </Tooltip>
        </Space>
