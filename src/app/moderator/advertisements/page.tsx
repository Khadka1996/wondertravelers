...
import { Plus, Edit2, Eye, EyeOff, Search, ChevronLeft, ChevronRight, Copy } from 'lucide-react';
      ...
      <div className="border-b border-gray-200 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/moderator/advertisements/add"
                    ...
                    <tr key={ad._id} className="hover:bg-gray-50 transition">
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-2">
                          <Link
                            href={`/moderator/advertisements/${ad._id}/edit`}
