...
function EditAdvertisementContent() {
  ...
  useEffect(() => {
    const fetchAd = async () => {
      try {
        ...
        setError(err instanceof Error ? err.message : 'Error fetching advertisement');
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      router.push('/moderator/advertisements');
    } catch (err) {
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div>
              <label className="block text-sm font-medium text-white mb-2">
                Advertisement Image <span className="text-red-400">*</span>
              </label>
              {preview ? (
            ...
            <div className="flex gap-4 pt-8 border-t border-gray-200">
              ...
              >
                {saving ? 'Saving...' : 'Update Advertisement'}
              </button>
              <Link
                href="/admin/advertisements"
